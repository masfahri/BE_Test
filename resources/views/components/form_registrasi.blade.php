          ...
          <div class="page-header">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                ...
                @endcomponent
                  <form action="{{ route('form_registrasi.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="card-body">
                  <div class="card-body">
                    <div class="row">
                    ...
                    <div class="controls mt-3"> 
                        <div class="entry ">
                            <h4 class="card-title mt-5"> Pengalaman Organisai </h4>
                                    <div class="row" id="original" style="border-bottom: 1px solid black; margin-bottom: 10px">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                ...
                                <span class="input-group-btn float-right">
                                    ...
                                    <button class="btn btn-danger btn-sm btn-remove" type="button"> Hapus Organisasi
                                        <span class="glyphicon glyphicon-plus"></span>
                                    </button>
                                </span>
                        </div>
