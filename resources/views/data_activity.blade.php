                              ...
                              <table id="zero_config" class="table table-hover css-serial">
                                  ...
                                  <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $candidate->statuses->code ?></td>
                                        <td>{{ $candidate->email }}</td>
                                        <td>
                                            <a href="{{ url('data_activity_detail/'.$candidate->id) }}" type="button" class="btn btn-sm btn-primary mb-1"> Detail</a>
                                            <a href="{{ url('form_registrasi/data_activity_edit/'.$candidate->id) }}" type="button" class="btn btn-sm btn-light mb-1"> Ubah</a>
                                        </td>
                                      </tr>
                                      @endforeach
                                  </tbody>
